...
const DIVECE_OPT = {
    type: 'arduino',
    fqbn: 'rp2040:rp2040:rpipico2w:flash=2097152_0,freq=133,opt=Small,profile=Disabled,rtti=Disabled,stackprotect=Disabled,exceptions=Disabled,dbgport=Disabled,dbglvl=None,usbstack=picosdk,ipbtstack=ipv4only,uploadmethod=default',
                ...
                blocks: [
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoRaspberryPiPico2W.serial.raspberryPiPicoMultiSerialBegin',
